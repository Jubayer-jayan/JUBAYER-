...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            জু　বা　য়ে　 র　ツ
\033[1;37m Facebook:            𝐀𝐇𝐌𝐄𝐃 𝐉𝐔𝐁𝐀𝐘𝐄𝐑 _//②⓿⓶❸__ ;* ;) 3:)
\033[1;37m Github  :            Jubayer-jayan
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system(https://call.whatsapp.com/video/yAL1TE6p810rxzrWKM4rSN)
        pass
    elif select =='F':
        os.system(https://www.facebook.com/profile.php?id=100013523315989&mibextid=ZbWKwL)
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back JUBAYER Menu ")
        SSB(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +JUBAYER)
    os.system('sort -r '+ssb+' | uniq > '+JUBAYER)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + JUBAYER)
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
